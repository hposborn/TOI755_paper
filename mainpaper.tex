...
\newcommand{\Tror}{ $ 0.0196 \pm 0.0013 $ }
...
\hline
\hline
Constituent & With H-He [\%] & With $_{2}$O [\%] & 4-layer [\%] \\
\hline
\hline
$M_{\rm core}/M_{\rm total}$ & $0.47 ^{+0.26} _{-0.24} $ & $0.08 ^{+0.07} _{-0.06}$ & $0.25 ^{+0.28} _{-0.18}$\\
$M_{\rm mantle}/M_{\rm total}$ & $ 0.53 ^{+0.23} _{-0.24} $ & $0.17 ^{+0.11} _{-0.09}$ & $0.36 ^{+0.31} _{-0.19}$\\
$M_{\rm water}/M_{\rm total}$ & --- & $0.73 ^{+0.10} _{-0.13}$ & $0.38 ^{+0.31} _{-0.24}$\\
$M_{\rm H-He}/M_{\rm total}$ & $0.01 ^{+0.003} _{-0.005}$ & --- & $(1.02  ^{+0.4} _{-0.3}) \times 10^{-3}$$\\
\hline
\hline
\end{tabular}
\end{table}
