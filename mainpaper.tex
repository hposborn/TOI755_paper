...
\newcommand{\Tteffiso}{ $ 5714.0 \pm 38.0 $ }
\newcommand{\Tloggiso}{ $ 4.464 \pm 0.022 $ }
\newcommand{\Tfehiso}{ $ 0.11^{+0.07}_{-0.87} $ }
\newcommand{\Tradiso}{ $ 0.984^{+0.016}_{-0.014} $ }
\newcommand{\Tmassiso}{ $ 1.035^{+0.017}_{-0.029} $ }
\newcommand{\Trhoiso}{ $ 1.082^{+0.055}_{-0.075} $ }
\newcommand{\Tlumiso}{ $ 0.931 \pm 0.027 $ }
\newcommand{\Tageiso}{ $ 2.3^{+1.8}_{-1.2} $ }
\newcommand{\Tavsiso}{ $ 0.13982 \pm 0.00054 $ }
\newcommand{\Tdisiso}{ $ 107.2 \pm 1.2 $ }
...
K.A. Collins$^{5}$, % karen.collins@cfa.harvard.edu SG1 coordination and data analysis
V. Adibekyan$^{6}$, % Vardan.Adibekyan@astro.up.pt Stellar abundances and ages
E. Delgado-Mena$^{6}$, % elisa.delgado@astro.up.pt Stellar abundances and ages
...
J. Lillo-Box$^{8}$, % jlillo@cab.inta-csic.es NCORES contributor, TPF plot
L.D. Nielsen$^{9}$, % louise.nielsen@unige.ch HARPS observations + data reduction, RV consulation
J.F. Otegi$^{9}$, % jon.otegi@unige.ch Internal structure models
N.C. Santos$^{6,10}$, % nuno.santos@astro.up.pt HARPS stellar analysis
C. Ziegler$^{11}$, % carl.ziegler@dunlap.utoronto.ca SOAR speckle imaging PI
C. Brice\~{n}o$^{12}$, % SOAR speckle imaging
D. Barrado$^{8}$, % barrado@cab.inta-csic.es NCORES observer
C. Burke$^{13}$, % cjburke@mit.edu POC contributor
T. Daylan$^{14}$, % tdaylan@mit.edu POC contributor
D. Dragomir$^{15}$, % TSO contributor
C. Hellier$^{15}$, % WASP archival photometry
E.L.N. Jensen$^{16}$, % ejensen1@swarthmore.edu SG1 coordination and observations
N. Law$^{17}$, % SOAR speckle imaging
D.M. Conti$^{18}$, % dennis@astrodennis.com SG1 data analysis
A. Mann$^{17}$, % SOAR speckle imaging
J.M. Jenkins$^{7}$, % TESS architect
A. Osborn$^{4,3}$, % e.osborn@warwick.ac.uk NCORES observer
G. Ricker$^{2}$, % TESS architect
D.R. Louie$^{19}$, % danalouie@astro.umd.edu TSO contributor
S. Seager$^{20}$, % TESS architect
N. Scott$^{7}$, % nic.scott.9@gmail.com Speckle observing, data reduction, analysis
B.V. Rackham$^{20,21}$, % brackham@mit.edu TSO contributor
J. Villaseñor$^{13}$, % jsvilla@space.mit.edu POC contributor
R. Vanderspek$^{2}$, % TESS architect
D.W. Latham$^{5}$, % TESS architect
J. Winn$^{15}$, % TESS architect
}\\
\parbox{\textwidth}{
